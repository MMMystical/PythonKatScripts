...
function Module:enable()
    ...
    aiConnection = AIFolder.ChildAdded:Connect(function(child)
        task.spawn(function()
    ...
    childRemovedConnection = AIFolder.ChildRemoved:Connect(function(child)
    ...
    renderConnection = RunService.RenderStepped:Connect(function()
        ...
        for instance, highlight in pairs(highlights) do
            if instance and instance.Parent == AIFolder then
