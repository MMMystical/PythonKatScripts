...
gui:set_scriptdisplay("Chat Bypasser v1.84 | PythonKat v0.13 🎆")

gui:notification{
	Title = "Chat Bypasser v1.84",
...
tab:button({
    Name = "P1⁥⁥ЅЅ",
    Callback = function()
        game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("P1⁥⁥ЅЅ", "All")
    end,
})
